...
<tr>
    <td>Volume: <xsl:value-of select="tei:biblStruct/tei:monogr/tei:biblScope[@unit='volume']"/><br/>
    Fascicolo: <xsl:value-of select="tei:biblStruct/tei:monogr/tei:biblScope[@unit='issue']"/><br/>
    Pagine: <xsl:value-of select="tei:biblStruct/tei:monogr/tei:biblScope[@unit='page']"/></td><br/>
</tr>
</table>
</div>
</xsl:template>
...
<xsl:template match="tei:addName[@type='epithet']">
    <xsl:element name="span">
        <xsl:attribute name="class">epiteti</xsl:attribute>
        <xsl:apply-templates />
    </xsl:element>
</xsl:template>
...
<xsl:template match="tei:persName">
    ...
    <xsl:element name="span">
        ...
        <xsl:element name="a">
            <xsl:attribute name="href"><xsl:value-of select="/tei:TEI/tei:text/tei:back/tei:div/tei:listPerson/tei:person[@xml:id=$person_ref]/tei:persName/tei:ref"/></xsl:attribute>
            <xsl:apply-templates />
        </xsl:element>
    </xsl:element>
...
<xsl:template match="tei:placeName">
    ...
    <xsl:element name="span">
        ...
        <xsl:element name="a">
            <xsl:attribute name="href"><xsl:value-of select="/tei:TEI/tei:text/tei:back/tei:div/tei:listPlace/tei:place[@xml:id=$place_ref]/tei:placeName/tei:ref/@target"/></xsl:attribute>
            <xsl:apply-templates />
        </xsl:element>
    </xsl:element>
